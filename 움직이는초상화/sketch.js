...
function draw() {
  ...
  if (dist(faceX, faceY, mouseX, mouseY) <= 140) {
    if (mouseIsPressed) {
      noStroke();
    fill("#ffe0e0");
    ellipse(301, 252, 45, 35);
    ellipse(mouseX, mouseY, 40);
    ellipse(mouseX, mouseY -7, 5);

    stroke(1);
    line(285, 252, 315, 252);
    arc(285, 252, 10, 20, radians(270), radians(90));
    arc(315, 252, 10, 20, radians(90), radians(270));
    } else {
      noStroke();
    fill("#994c4c");
    ellipse(301, 252, 45, 35);
